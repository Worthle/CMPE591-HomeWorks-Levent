...
<p align="center">
  ...
  It can be seen that the curves converging to a minimum point. One this I couldn't understand is that why the validation loss is always less than training loss.
