...
if __name__ == "__main__":
    ...
    agent.actor.load_state_dict(torch.load("SAC/SACactor_model19030_9600.pt"))
    agent.critic1.load_state_dict(torch.load("SAC/SACcritic1_model19030_9600.pt"))
    agent.critic2.load_state_dict(torch.load("SAC/SACcritic2_model19030_9600.pt"))
    agent.actor.eval()
    agent.critic1.eval()
    agent.critic2.eval()
    episode_rewards = []
